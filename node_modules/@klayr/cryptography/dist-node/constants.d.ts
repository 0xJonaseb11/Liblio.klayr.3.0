...
export declare const DEFAULT_KLAYR32_ADDRESS_PREFIX = "kly";
...
export declare const L = 8160;
export declare const EMPTY_SALT: Buffer;
export declare const EMPTY_BUFFER: Buffer;
export declare const SHA256 = "sha256";
export declare const KLAYR32_CHARSET = "zxvcpmbn3465o978uyrtkqew2adsjhfg";
export declare const KLAYR32_ADDRESS_LENGTH = 41;
export declare const MESSAGE_TAG_NON_PROTOCOL_MESSAGE = "KLY_NPM_";
