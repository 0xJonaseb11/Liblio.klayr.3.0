...
const codec_2 = require("./utils/codec");
...
const createPeerPoolConfig = (config, peerBook) => ({
    ...
    rpcSchemas: config.customNodeInfoSchema
        ? {
            nodeInfo: (0, schema_1.mergeCustomSchema)(schema_1.nodeInfoSchema, config.customNodeInfoSchema),
...
class P2P extends events_1.EventEmitter {
    constructor(config) {
        ...
        this._sanitizedPeerLists = (0, utils_1.sanitizePeerLists)({
            ...
            peerId: (0, utils_1.constructPeerId)((_a = config.hostIp) !== null && _a !== void 0 ? _a : constants_1.DEFAULT_NODE_HOST_IP, config.port),
        ...
        this._rpcSchemas = config.customNodeInfoSchema
            ...
            : schema_1.defaultRPCSchemas;
        codec_1.codec.addSchema(this._rpcSchemas.peerInfo);
        codec_1.codec.addSchema(this._rpcSchemas.nodeInfo);
        codec_1.codec.addSchema(this._rpcSchemas.peerRequestResponse);
        this._networkStats = {
            startTime: Date.now(),
            incoming: {
                count: 0,
        ...
        this._handlePeerPoolMessage = (message) => {
            ...
            if (message.event === events_2.REMOTE_EVENT_POST_NODE_INFO) {
                const decodedNodeInfo = codec_1.codec.decode(schema_1.nodeInfoSchema, message.data);
        ...
        this._handlePeerCloseOutbound = (closePacket) => {
            ...
            if (this._peerBook.getPeer(closePacket.peerInfo)) {
                const updatedPeer = {
                    ...peerInfo,
                    internalState: (0, utils_1.assignInternalInfo)(peerInfo, this._secret),
                };
        ...
        this._handleInboundPeerConnect = (incomingPeerConnection) => {
            if (!(0, validator_1.isIPV4)(incomingPeerConnection.socket.remoteAddress)) {
        ...
        this._nodeInfo = {
            ...config.nodeInfo,
            nonce: cryptography_1.utils.getRandomBytes(constants_1.DEFAULT_NONCE_LENGTH_BYTES).toString('hex'),
        };
    ...
    _handleGetNodeInfo(request) {
        if (!(0, validate_1.isEmptyMessage)(request.data)) {
            this.applyPenalty({
        ...
        const encodedNodeInfo = (0, codec_2.encodeNodeInfo)(this._rpcSchemas.nodeInfo, this._nodeInfo);
    ...
    _handleGetPeersRequest(request) {
        ...
        const encodedPeersList = sanitizedPeerInfoList.map(peer => (0, codec_2.encodePeerInfo)(this._rpcSchemas.peerInfo, peer));
        const validatedPeerList = (0, utils_1.getByteSize)(encodedPeersList) < wsMaxPayload
            ? encodedPeersList
            : encodedPeersList.slice(0, safeMaxPeerInfoLength);
        const encodedResponse = codec_1.codec.encode(this._rpcSchemas.peerRequestResponse, {
