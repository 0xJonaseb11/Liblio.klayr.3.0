...
exports.klayr32 = exports.oddInteger = exports.ipOrFQDN = exports.ip = exports.encryptedPassphrase = exports.path = exports.networkVersion = exports.version = exports.camelCase = exports.uint32 = exports.uint64 = exports.int64 = exports.bytes = exports.hex = void 0;
...
const klayr32 = (data) => {
    try {
        cryptography_1.address.validateKlayr32Address(data);
        return true;
    }
    catch (error) {
        return false;
