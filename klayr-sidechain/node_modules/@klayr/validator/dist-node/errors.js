...
exports.KlayrvalidationError = exports.convertErrorsToLegacyFormat = void 0;
...
class KlayrvalidationError extends Error {
    constructor(errors) {
        super();
        this.errors = (0, exports.convertErrorsToLegacyFormat)(errors);
        this.message = `Klayr validator found ${this.errors.length} error[s]:\n${this._compileErrors().join('\n')}`;
    }
    _compileErrors() {
        return this.errors.map(errorFormatter);
    }
}
exports.KlayrvalidationError = KlayrvalidationError;
