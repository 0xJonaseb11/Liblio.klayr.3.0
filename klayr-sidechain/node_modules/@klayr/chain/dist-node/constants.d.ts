...
export declare const DEFAULT_KEEP_INCLUSION_PROOFS_FOR_HEIGHTS = 300;
...
export declare const LENGTH_ADDRESS = 20;
...
export declare const MAX_ASSET_DATA_SIZE_BYTES = 18;
...
export declare const MAX_PARAMS_SIZE: number;
