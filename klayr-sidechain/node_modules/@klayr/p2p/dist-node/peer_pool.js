...
class PeerPool extends events_1.EventEmitter {
    constructor(peerPoolConfig) {
        ...
        codec_1.codec.addSchema(this._rpcSchema.nodeInfo);
        this._peerConfig = {
    ...
    _applyNodeInfoOnPeer(peer) {
        const encodedNodeInfo = (0, codec_2.encodeNodeInfo)(this._rpcSchema.nodeInfo, this._nodeInfo);
        (0, utils_1.validatePayloadSize)(encodedNodeInfo, this._peerPoolConfig.maxPeerInfoSize);
        try {
            peer.send({
    ...
    _selectPeersForEviction() {
        ...
        const protectedPeersByNetgroup = this._peerPoolConfig.netgroupProtectionRatio
            ? (0, exports.filterPeersByCategory)(peers, {
        ...
        const protectedPeersByConnectTime = this._peerPoolConfig.longevityProtectionRatio
            ? new Set([
                ...(0, exports.filterPeersByCategory)(unprotectedPeers, {
