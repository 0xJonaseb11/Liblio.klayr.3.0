...
const assignInternalInfo = (peerInfo, secret) => peerInfo.internalState
    ...
    : {
        ...
        netgroup: (0, network_1.getNetgroup)(peerInfo.ipAddress, secret),
        latency: 0,
...
const sanitizeIncomingPeerInfo = (peerInfo) => {
    ...
    return {
        peerId: (0, network_1.constructPeerId)(ipAddress, port),
        ipAddress,
        port,
        sharedState: {
            ...restOfPeerInfo,
...
const sanitizeInitialPeerInfo = (peerInfo) => ({
    peerId: (0, network_1.constructPeerId)(peerInfo.ipAddress, peerInfo.port),
...
const sanitizePeerLists = (lists, nodeInfo, secret) => {
    ...
    const fixedPeers = lists.fixedPeers
        .filter(peerInfo => {
        if (!(0, validator_1.isIPV4)(peerInfo.ipAddress)) {
            return false;
        }
        ...
        .map(peer => {
        const peerInternalInfo = (0, exports.assignInternalInfo)(peer, secret);
        return {
            ...peer,
