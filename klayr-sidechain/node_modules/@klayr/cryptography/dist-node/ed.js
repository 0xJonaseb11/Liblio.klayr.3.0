...
const signedMessageHeader = createHeader('BEGIN KLAYR SIGNED MESSAGE');
...
const signatureFooter = createHeader('END KLAYR SIGNED MESSAGE');
...
const getPrivateKeyFromPhraseAndPath = async (phrase, path) => {
    const masterSeed = await passphrase_1.Mnemonic.mnemonicToSeed(phrase);
