...
exports.codec = exports.Codec = exports.validateSchema = exports.emptySchema = void 0;
...
const validateSchema = (schema) => {
    var _a;
    validator_1.validator.removeSchema(schema.$id);
    const schemaToValidate = {
        ...schema,
        $schema: (_a = schema.$schema) !== null && _a !== void 0 ? _a : validator_1.klayrschemaIdentifier,
    };
    validator_1.validator.validateSchema(schemaToValidate);
    try {
        validator_1.validator.compile(schemaToValidate);
    }
    finally {
        validator_1.validator.removeSchema(schema.$id);
    }
...
class Codec {
    ...
    addSchema(schema) {
        (0, exports.validateSchema)(schema);
    ...
    encode(schema, message) {
        ...
        const res = (0, collection_1.writeObject)(compiledSchema, message, []);
    ...
    decode(schema, message) {
        ...
        const compiledSchema = this._compileSchemas[schema.$id];
        const [res] = (0, collection_1.readObject)(message, 0, compiledSchema, message.length);
        return res;
    }
    ...
    toJSON(schema, message) {
        const messageCopy = utils_1.objects.cloneDeep(message);
        messageCopy[Symbol.iterator] = json_wrapper_1.iterator;
        (0, json_wrapper_1.recursiveTypeCast)('toJSON', messageCopy, schema, []);
        return messageCopy;
    }
    fromJSON(schema, message) {
        const messageCopy = utils_1.objects.cloneDeep(message);
        messageCopy[Symbol.iterator] = json_wrapper_1.iterator;
        (0, json_wrapper_1.recursiveTypeCast)('fromJSON', messageCopy, schema, []);
        return messageCopy;
    }
    clearCache() {
        this._compileSchemas = {};
                    ...
                    const nestedSchema = [
                        {
                            ...
                            dataPath: [...dataPath],
                            binaryKey: (0, utils_2.generateKey)(schemaPropertyValue),
                        },
                    ];
