...
const writeUInt32 = (value) => {
    if (value > validator_1.MAX_UINT32) {
...
const writeSInt32 = (value) => {
    if (value > validator_1.MAX_SINT32) {
        throw new Error('Value out of range of sint32');
    }
    if (value >= 0) {
        return (0, exports.writeUInt32)(2 * value);
    }
    return (0, exports.writeUInt32)(-2 * value - 1);
};
exports.writeSInt32 = writeSInt32;
const writeUInt64 = (value) => {
    if (value > validator_1.MAX_UINT64) {
...
const writeSInt64 = (value) => {
    if (value > validator_1.MAX_SINT64) {
        throw new Error('Value out of range of sint64');
    }
    if (value >= BigInt(0)) {
        return (0, exports.writeUInt64)(BigInt(2) * value);
    }
    return (0, exports.writeUInt64)(BigInt(-2) * value - BigInt(1));
};
...
const readSInt32 = (buffer, offset) => {
    const [varInt, size] = (0, exports.readUInt32)(buffer, offset);
    if (varInt % 2 === 0) {
...
const readSInt64 = (buffer, offset) => {
    const [varInt, size] = (0, exports.readUInt64)(buffer, offset);
...
const validateVarintSize = (result, size) => {
