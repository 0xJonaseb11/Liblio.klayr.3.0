...
exports.MintEvent = exports.mintEventSchema = void 0;
const base_event_1 = require("../../base_event");
const constants_1 = require("../constants");
exports.mintEventSchema = {
...
class MintEvent extends base_event_1.BaseEvent {
    constructor() {
        super(...arguments);
        this.schema = exports.mintEventSchema;
    }
    log(ctx, data) {
