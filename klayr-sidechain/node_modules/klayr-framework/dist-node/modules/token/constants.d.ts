...
export declare const CROSS_CHAIN_COMMAND_NAME_TRANSFER = "transferCrossChain";
export declare const ADDRESS_LENGTH = 20;
export declare const MAX_DATA_LENGTH = 64;
...
export declare const CCM_STATUS_OK = 0;
export declare const CCM_STATUS_TOKEN_NOT_SUPPORTED = 64;
export declare const CCM_STATUS_PROTOCOL_VIOLATION = 65;
...
export declare const LOCAL_ID_KLY: Buffer;
export declare const USER_ACCOUNT_INITIALIZATION_FEE: bigint;
export declare const ESCROW_ACCOUNT_INITIALIZATION_FEE: bigint;
export declare const defaultConfig: {
    userAccountInitializationFee: string;
    escrowAccountInitializationFee: string;
};
export declare const EMPTY_BYTES: Buffer;
export declare const enum TokenEventResult {
    SUCCESSFUL = 0,
