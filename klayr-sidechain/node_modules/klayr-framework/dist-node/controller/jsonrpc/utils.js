...
function validateJSONRPCRequest(data) {
    ...
    validator_1.validator.validate(requestSchema, data);
}
exports.validateJSONRPCRequest = validateJSONRPCRequest;
const validateJSONRPCNotification = (data) => {
    validator_1.validator.validate(notificationSchema, data);
};
...
const invalidRequest = (msg) => ({
    message: msg !== null && msg !== void 0 ? msg : 'Invalid request',
    code: -32600,
});
